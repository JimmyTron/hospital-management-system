      ...
      <div class='alert alert-info'>
            ...
            <div class="form-group" >
             ...
             <div class="form-group">
              ...
              <input type="tel" class="form-control" id="pwd" name="email" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="pwd" name="age"  required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="tel" class="form-control" id="pwd" name="specialization" required>
            </div>
              <div class="form-group">
            ...
            <div class="form-group">
              <input type="submit"  name="submit-add" class="btn btn-primary" >
